                    ...
                    <div className="max-w-2xl">
                        <div className="relative">
                            ...
                            <p className="text-2xl text-gray-100 mb-8 max-w-lg">
                                Join DOZ, where future leaders forge their paths through action, innovation, and purposeful collaboration.
                            </p>

                            <div className="flex gap-6 items-center">
                                <button className="group relative px-8 py-4 bg-emerald-500 text-white rounded-lg overflow-hidden">
                                ...
                                <a href="#about" className="text-gray-100 hover:text-emerald-400 transition-colors relative group">
                                    Learn More
                        ...
                        {/* Floating Decorative Elements - now more subtle */}
